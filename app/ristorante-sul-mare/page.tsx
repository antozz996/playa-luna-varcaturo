...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/ristorante-sul-mare/",
  },
  openGraph: {
    title: "Ristorante Playa Luna sul mare",
    description:
      "Cucina mediterranea e pranzo sul mare a Varcaturo.",
...
export default async function RestaurantPage() {
  ...
  return (
    <ServicePage
      ...
      image={mediaUrl(
        media.hero,
        "/images/playa-luna/restaurant/hero.webp",
      )}
      imageAlt={mediaAlt(
        media.hero,
      ...
      detailAlt={mediaAlt(
        media.detail,
        "Piatto di pasta mediterranea preparato al ristorante Playa Luna",
      )}
      features={[
